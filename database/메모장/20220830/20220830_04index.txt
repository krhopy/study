...
파일 → 새로만들기 → 데이터베이스계층 → 데이터베이스 파일
    i:\java202207\database\20220830_04index.sql
...
select * from emp4 where no=466;        -- FULL scan, COST 899
